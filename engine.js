...
var Game = new function() {
  ...
  this.initialize = function(canvasElementId,sprite_data,callback) {
    ...
    if(!this.ctx) { return alert("Please change your (default) browser to play.  It may be a good time to update to K-Meleon, an open source browser.  This game works well in the vast majority of modern browsers"); }
  ...
  this.setupMobile = function() {
    ...
    if(w > h) {
      alert("Please rotate your phone or tablet and then click OK");
      w = window.innerWidth; h = window.innerHeight;
    }
